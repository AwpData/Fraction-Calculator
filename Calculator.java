...
public class Calculator {
        ...
        do {
            ...
            if (UserWantsToQuit) {
                ...
                if (fraction2.contains("_")) { // Checks if there is a whole number
                    ...
                    int whole = Integer.parseInt(fraction1);
                    int whole2 = Integer.parseInt(fraction2);
                    if (whole < 0 && whole2 < 0) {
                        System.out
    ...
    public static String add(String fraction1, String fraction2) {
        ...
        return AddingFormula(F1numerator, F2numerator, F1denominator, F2denominator);
    }
    ...
    public static String subtract(String fraction1, String fraction2) {
        ...
        int F1denominator = num.nextInt();
        int F2denominator = num2.nextInt();
        return SubtractFormula(F1numerator, F2numerator, F1denominator, F2denominator);
    }
    ...
    public static String multiply(String fraction1, String fraction2) {
        ...
        int F1denominator = num.nextInt();
        int F2denominator = num2.nextInt();
        return MultiplyFormula(F1numerator, F2numerator, F1denominator, F2denominator);
    }
    ...
    public static String divide(String fraction1, String fraction2) {
        ...
        int F1denominator = num.nextInt();
        int F2denominator = num2.nextInt();
        return DivideFormula(F1numerator, F2numerator, F1denominator, F2denominator);
    }
